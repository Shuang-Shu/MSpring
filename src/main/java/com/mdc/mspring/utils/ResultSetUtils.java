...
public class ResultSetUtils {
    public static <T> T constructAndSetFieldsUseResultSet(Class<T> clazz, ResultSet resultSet) throws InvocationTargetException, InstantiationException, IllegalAccessException, SQLException {
